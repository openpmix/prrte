...
AC_DEFUN([PRRTE_CHECK_ICC_VARARGS],[
dnl
...
],[prrte_ac_icc_varargs=`test -f conftestval`],[prrte_ac_icc_varargs=1],[prrte_ac_icc_varargs=1])

if test "$prrte_ac_icc_varargs" = "1"; then
