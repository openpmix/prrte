...
AC_DEFUN([_PRTE_CHECK_PACKAGE_LIB], [
    ...
    # cache variable for the library check.  one should not copy this
    # code into other places unless you want much pain and suffering
    AS_VAR_PUSHDEF([prte_Lib], [ac_cv_search_$3])
...
AC_DEFUN([PRTE_CHECK_PACKAGE],[
    ...
    prte_check_package_$1_orig_CPPFLAGS="$$1_CPPFLAGS"
    prte_check_package_$1_orig_LDFLAGS="$$1_LDFLAGS"
    prte_check_package_$1_orig_LIBS="$$1_LIBS"

    _PRTE_CHECK_PACKAGE_HEADER([$1], [$2], [$6],
          [_PRTE_CHECK_PACKAGE_LIB([$1], [$3], [$4], [$5], [$6], [$7],
                [prte_check_package_happy="yes"],
                [prte_check_package_happy="no"])],
          [prte_check_package_happy="no"],
          [$10])

    AS_IF([test "$prte_check_package_happy" = "yes"],
          [$8],
          [$1_CPPFLAGS="$prte_check_package_$1_orig_CPPFLAGS"
           $1_LDFLAGS="$prte_check_package_$1_orig_LDFLAGS"
           $1_LIBS="$prte_check_package_$1_orig_LIBS"
           $9])
