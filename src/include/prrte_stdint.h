...
#ifndef PRRTE_STDINT_H
#define PRRTE_STDINT_H 1
...
typedef int128_t prrte_int128_t;
typedef uint128_t prrte_uint128_t;

#define HAVE_PRRTE_INT128_T 1
...
#endif
typedef __int128 prrte_int128_t;
typedef unsigned __int128 prrte_uint128_t;
