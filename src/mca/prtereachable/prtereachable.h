 ...
 *
 */
typedef prte_reachable_t*
(*prte_reachable_base_module_reachable_fn_t)(prte_list_t *local_ifs,
 ...
 */
#define PRTE_REACHABLE_BASE_VERSION_2_0_0             \
    PRTE_MCA_BASE_VERSION_2_1_0("prtereachable", 2, 0, 0)
