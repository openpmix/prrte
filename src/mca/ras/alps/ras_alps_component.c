...
{
    param_priority = 75;
    (void) pmix_mca_base_component_var_register(&prte_mca_ras_alps_component.base_version, "priority",
                                                "Priority of the alps ras component",
                                                PMIX_MCA_BASE_VAR_TYPE_INT, &param_priority);

    ras_alps_read_attempts = 10;
    (void) pmix_mca_base_component_var_register(&prte_mca_ras_alps_component.base_version,
    ...
    (void) pmix_mca_base_component_var_register(&prte_mca_ras_alps_component.base_version, "apstat_cmd",
