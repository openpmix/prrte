 ...
 * freed during the call to prrte_dl_base_module_dlclose_fn_t).
 *
 ...
 * change after successive calls to prrte_dl API calls.
 */
typedef int (*prrte_dl_base_module_open_fn_t)
 ...
 * change after successive calls to prrte_dl API calls.
 */
typedef int (*prrte_dl_base_module_lookup_fn_t)
 ...
 */
typedef int (*prrte_dl_base_module_close_fn_t)
 ...
 */
typedef int (*prrte_dl_base_module_foreachfile_fn_t)
 ...
 */
struct prrte_dl_base_component_1_0_0_t {
    /** MCA base component */
...
typedef struct prrte_dl_base_component_1_0_0_t prrte_dl_base_component_1_0_0_t;
typedef struct prrte_dl_base_component_1_0_0_t prrte_dl_base_component_t;

/**
 * Structure for DL modules
 */
struct prrte_dl_base_module_1_0_0_t {
    prrte_mca_base_module_2_0_0_t                 super;

    /** Open / close */
    prrte_dl_base_module_open_fn_t           open;
    prrte_dl_base_module_close_fn_t          close;

    /** Lookup a symbol */
    prrte_dl_base_module_lookup_fn_t         lookup;

    /** Iterate looking for files */
    prrte_dl_base_module_foreachfile_fn_t    foreachfile;
};
typedef struct prrte_dl_base_module_1_0_0_t prrte_dl_base_module_1_0_0_t;
typedef struct prrte_dl_base_module_1_0_0_t prrte_dl_base_module_t;

/**
 * Macro for use in components that are of type DL
 */
#define PRRTE_DL_BASE_VERSION_1_0_0              \
    PRRTE_MCA_BASE_VERSION_2_1_0("dl", 1, 0, 0)
