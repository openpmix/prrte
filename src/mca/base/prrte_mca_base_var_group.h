...
#ifndef PRRTE_MCA_BASE_VAR_GROUP_H
#define PRRTE_MCA_BASE_VAR_GROUP_H

#include "src/mca/mca.h"

struct prrte_mca_base_var_group_t {
    ...
    prrte_value_array_t group_subgroups;

    /** Integer array of group variables */
    prrte_value_array_t group_vars;

    /** Pointer array of group enums */
    prrte_value_array_t group_enums;
};

typedef struct prrte_mca_base_var_group_t prrte_mca_base_var_group_t;

/**
 * Object declaration for mca_base_var_group_t
 */
PRRTE_EXPORT PRRTE_CLASS_DECLARATION(prrte_mca_base_var_group_t);
 ...
 */
PRRTE_EXPORT int prrte_mca_base_var_group_register(const char *project_name,
 ...
 * @return prrte error code on Error
 */
PRRTE_EXPORT int prrte_mca_base_var_group_component_register (const prrte_mca_base_component_t *component,
                                                              const char *description);
 ...
 */
PRRTE_EXPORT int prrte_mca_base_var_group_deregister (int group_index);
 ...
 *
 * @returns PRRTE_SUCCESS if found
 * @returns PRRTE_ERR_NOT_FOUND if not found
 */
PRRTE_EXPORT int prrte_mca_base_var_group_find (const char *project_name,
                                                const char *framework_name,
                                                const char *component_name);
 ...
 * @returns PRRTE_ERR_NOT_FOUND if not found
 */
PRRTE_EXPORT int prrte_mca_base_var_group_find_by_name (const char *full_name, int *index);
 ...
 *
 * @retval PRRTE_ERR_NOT_FOUND If the group specified by group_index does not exist.
 * @retval PRRTE_SUCCESS If the group is found
 *
 * The returned pointer belongs to the MCA variable system. Do not modify/release/retain
 * the pointer.
 */
PRRTE_EXPORT int prrte_mca_base_var_group_get (const int group_index,
 ...
 */
PRRTE_EXPORT int prrte_mca_base_var_group_set_var_flag (const int group_index, int flags,
                                                        bool set);
 ...
 */
PRRTE_EXPORT int prrte_mca_base_var_group_get_count (void);
 ...
 */
PRRTE_EXPORT int prrte_mca_base_var_group_get_stamp (void);

#endif /* PRRTE_MCA_BASE_VAR_GROUP_H */
