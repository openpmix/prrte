...
static PRTE_CLASS_INSTANCE(prte_mca_base_var_enum_flag_t, prte_object_t, mca_base_var_enum_flag_constructor,
...
static int enum_get_value (prte_mca_base_var_enum_t *self, int index, int *value, const char **string_value);
...
static int mca_base_var_enum_bool_get_value (prte_mca_base_var_enum_t *self, int index,
...
static prte_mca_base_var_enum_value_t verbose_values[] = {
    {PRTE_MCA_BASE_VERBOSE_NONE,      "none"},
    {PRTE_MCA_BASE_VERBOSE_ERROR,     "error"},
    {PRTE_MCA_BASE_VERBOSE_COMPONENT, "component"},
...
int prte_mca_base_var_enum_create (const char *name, const prte_mca_base_var_enum_value_t *values, prte_mca_base_var_enum_t **enumerator)
{
...
int prte_mca_base_var_enum_create_flag (const char *name, const prte_mca_base_var_enum_value_flag_t *flags, prte_mca_base_var_enum_flag_t **enumerator)
{
...
static int enum_dump (prte_mca_base_var_enum_t *self, char **out)
{
    ...
    *out = NULL;
    ...
    for (i = 0; i < self->enum_value_count && self->enum_values[i].string ; ++i) {
        ret = prte_asprintf (out, "%s%s%d:\"%s\"", tmp ? tmp : "", tmp ? ", " : "", self->enum_values[i].value,
...
static int enum_value_from_string(prte_mca_base_var_enum_t *self, const char *string_value, int *value_out) {
...
static int enum_string_from_value(prte_mca_base_var_enum_t *self, const int value, char **string_value) {
    int count, ret, i;
...
static int enum_get_value_flag (prte_mca_base_var_enum_t *self, int index, int *value, const char **string_value)
{
...
static int enum_value_from_string_flag (prte_mca_base_var_enum_t *self, const char *string_value, int *value_out) {
    prte_mca_base_var_enum_flag_t *flag_enum = (prte_mca_base_var_enum_flag_t *) self;
...
static int enum_string_from_value_flag (prte_mca_base_var_enum_t *self, const int value, char **string_value) {
    prte_mca_base_var_enum_flag_t *flag_enum = (prte_mca_base_var_enum_flag_t *) self;
    ...
    for (int i = 0 ; i < count ; ++i) {
        ...
        ret = prte_asprintf (&out, "%s%s%s", tmp ? tmp : "", tmp ? "," : "", flag_enum->enum_flags[i].string);
        free (tmp);
...
static int enum_dump_flag (prte_mca_base_var_enum_t *self, char **out)
{
    ...
    *out = strdup ("Comma-delimited list of: ");
    ...
    for (int i = 0; i < self->enum_value_count ; ++i) {
        ...
        ret = prte_asprintf (out, "%s%s0x%x:\"%s\"", tmp, i ? ", " : " ", flag_enum->enum_flags[i].flag,
                                     ...
                                     void *storage)
{
    ...
    group_index = prte_mca_base_var_group_register (project_name, framework_name, component_name, NULL);
    if (-1 > group_index) {
        return group_index;
    }
