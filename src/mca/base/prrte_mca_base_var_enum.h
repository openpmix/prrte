...
#if !defined(PRRTE_MCA_BASE_VAR_ENUM_H)
#define PRRTE_MCA_BASE_VAR_ENUM_H
...
typedef struct prrte_mca_base_var_enum_t prrte_mca_base_var_enum_t;
 ...
 */
typedef int (*prrte_mca_base_var_enum_get_count_fn_t)(prrte_mca_base_var_enum_t *self, int *count);
 ...
 */
typedef int (*prrte_mca_base_var_enum_get_value_fn_t)(prrte_mca_base_var_enum_t *self, int index,
 ...
 *
 * @retval PRRTE_SUCCESS if found
 * @retval PRRTE_ERR_VALUE_OUT_OF_BOUNDS if not
 */
typedef int (*prrte_mca_base_var_enum_vfs_fn_t)(prrte_mca_base_var_enum_t *self, const char *string_value,
                                                int *value);
 ...
 * @retval prrte error on error
 */
typedef int (*prrte_mca_base_var_enum_dump_fn_t)(prrte_mca_base_var_enum_t *self, char **out);
 ...
 *
 * @retval PRRTE_SUCCESS on success
 * @retval PRRTE_ERR_VALUE_OUT_OF_BOUNDS if not found
 *
 ...
 */
typedef int (*prrte_mca_base_var_enum_sfv_fn_t)(prrte_mca_base_var_enum_t *self, const int value,
                                          char **string_value);
 ...
 */
struct prrte_mca_base_var_enum_value_t {
    int value;
    const char *string;
};

typedef struct prrte_mca_base_var_enum_value_t prrte_mca_base_var_enum_value_t;

/**
 * enumerator base class
 */
struct prrte_mca_base_var_enum_t {
    ...
    prrte_mca_base_var_enum_get_count_fn_t get_count;
    /** Get the value and string representation for a particular index. Subclasses should
        override the default function */
    prrte_mca_base_var_enum_get_value_fn_t get_value;
    /** Given a string return corresponding integer value. If the string does not match a
     valid value return PRRTE_ERR_VALUE_OUT_OF_BOUNDS */
    prrte_mca_base_var_enum_vfs_fn_t value_from_string;
    /** Given an integer return the corresponding string value. If the integer does not
        match a valid value return PRRTE_ERR_VALUE_OUT_OF_BOUNDS */
    prrte_mca_base_var_enum_sfv_fn_t string_from_value;
    /** Dump a textual representation of the enumerator. The caller is responsible for
        freeing the string */
    prrte_mca_base_var_enum_dump_fn_t dump;
    ...
    prrte_mca_base_var_enum_value_t *enum_values;
};
 ...
 */
struct prrte_mca_base_var_enum_value_flag_t {
...
typedef struct prrte_mca_base_var_enum_value_flag_t prrte_mca_base_var_enum_value_flag_t;

/**
 * flag enumerator base class
 */
struct prrte_mca_base_var_enum_flag_t {
    /** use the existing enumerator interface */
    prrte_mca_base_var_enum_t super;
    /** flag value(s) */
    prrte_mca_base_var_enum_value_flag_t *enum_flags;
};

typedef struct prrte_mca_base_var_enum_flag_t prrte_mca_base_var_enum_flag_t;

/**
 * Object declaration for mca_base_var_enum_t
 */
PRRTE_EXPORT PRRTE_CLASS_DECLARATION(prrte_mca_base_var_enum_t);
 ...
 *
 * @retval PRRTE_SUCCESS On success
 * @retval prrte error code On error
 *
 * This function creates a value enumerator for integer variables. The
 * OUT enumerator value will be a newly PRRTE_NEW'ed object that should
 * be released by the caller via PRRTE_RELEASE.
 *
 * Note that the output enumerator can be PRRTE_RELEASE'd after it has
 * been used in a cvar registration, because the variable
 * registration functions will PRRTE_RETAIN the enumberator.
 *
 ...
 * returns.
 */
PRRTE_EXPORT int prrte_mca_base_var_enum_create (const char *name, const prrte_mca_base_var_enum_value_t values[],
                                            prrte_mca_base_var_enum_t **enumerator);
 ...
 * returns.
 */
PRRTE_EXPORT int prrte_mca_base_var_enum_create_flag (const char *name, const prrte_mca_base_var_enum_value_flag_t flags[],
                                                 prrte_mca_base_var_enum_flag_t **enumerator);

PRRTE_EXPORT int prrte_mca_base_var_enum_register(const char *project_name, const char *framework_name,
                                             const char *component_name, const char *enum_name,
                                             void *storage);
/* standard enumerators. it is invalid to call PRRTE_RELEASE on any of these enumerators */
/**
 * Boolean enumerator
 *
 ...
 */
extern prrte_mca_base_var_enum_t prrte_mca_base_var_enum_bool;
 ...
 *   auto -> -1
 */
extern prrte_mca_base_var_enum_t prrte_mca_base_var_enum_auto_bool;

/**
 * Verbosity level enumerator
 */
extern prrte_mca_base_var_enum_t prrte_mca_base_var_enum_verbose;
