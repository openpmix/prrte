 ...
 */
PMIX_CLASS_INSTANCE(prte_mca_base_component_list_item_t, pmix_list_item_t, cl_constructor, NULL);

/*
 * Class instance of the mca_base_component_priority_list_item_t class
 */
PMIX_CLASS_INSTANCE(prte_mca_base_component_priority_list_item_t,
