 ...
 * @retval prte error code on failure
 *
 ...
 *
 * This function is invoked during prte_init() and during the
 ...
 * framework, and is called during prte_finalize() and the
...
typedef enum {
     ...
     */
} prte_mca_base_framework_flags_t;
