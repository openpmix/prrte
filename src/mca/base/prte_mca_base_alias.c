...
PRTE_CLASS_INSTANCE(prte_mca_base_alias_t, prte_object_t,
                    prte_mca_base_alias_init,
...
PRTE_CLASS_INSTANCE(prte_mca_base_alias_item_t, prte_list_item_t,
                    prte_mca_base_alias_item_init,
...
void prte_mca_base_alias_cleanup (void)
{
    ...
    void *key;
    prte_object_t *value;
    PRTE_HASH_TABLE_FOREACH_PTR(key, value, alias_hash_table, {
        PRTE_RELEASE(value);
    });
...
static char *prte_mca_base_alias_generate_name (const char *project,
...
int prte_mca_base_alias_register (const char *project, const char *framework, const char *component_name,
...
const prte_mca_base_alias_t *prte_mca_base_alias_lookup(const char *project,
                                                        const char *framework,
                                                        const char *component_name)
{
    if (NULL == component_name) {
