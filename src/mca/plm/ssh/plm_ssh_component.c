...
static int ssh_component_register(void)
{
    ...
    (void) pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_INT, &prte_mca_plm_ssh_component.num_concurrent);
    ...
    (void) pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_BOOL, &prte_mca_plm_ssh_component.disable_qrsh);
    ...
    (void) pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_BOOL, &prte_mca_plm_ssh_component.daemonize_qrsh);
    ...
    (void) pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_BOOL, &prte_mca_plm_ssh_component.disable_llspawn);
    ...
    (void) pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_BOOL, &prte_mca_plm_ssh_component.daemonize_llspawn);
    ...
    (void) pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_BOOL, &prte_mca_plm_ssh_component.no_tree_spawn);
    ...
    var_id = pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_STRING, &prte_mca_plm_ssh_component.agent);
    ...
    var_id = pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_BOOL, &prte_mca_plm_ssh_component.assume_same_shell);
    ...
    (void) pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_BOOL, &prte_mca_plm_ssh_component.pass_environ_mca_params);
    ...
    (void) pmix_mca_base_component_var_register(
        ...
        PMIX_MCA_BASE_VAR_TYPE_STRING, &prte_mca_plm_ssh_component.pass_libpath);

    prte_mca_plm_ssh_component.chdir = NULL;
    (void) pmix_mca_base_component_var_register(
        c, "chdir", "Change working directory after ssh, but before exec of prted",
        PMIX_MCA_BASE_VAR_TYPE_STRING, &prte_mca_plm_ssh_component.chdir);
    return PRTE_SUCCESS;
}
