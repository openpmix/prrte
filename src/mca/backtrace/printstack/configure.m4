...
# $HEADER$
#
AC_DEFUN([MCA_prrte_backtrace_printstack_PRIORITY], [30])

AC_DEFUN([MCA_prrte_backtrace_printstack_COMPILE_MODE], [
...
# ------------------------------------------------
AC_DEFUN([MCA_prrte_backtrace_printstack_CONFIG],[
    AC_CONFIG_FILES([src/mca/backtrace/printstack/Makefile])
