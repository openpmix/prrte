...
static struct option prterunoptions[] = {
    ...
    PMIX_OPTION_DEFINE(PRTE_CLI_DVM, PMIX_ARG_OPTIONAL),
    ...
    PMIX_OPTION_DEFINE(PRTE_CLI_STOP_ON_EXEC, PMIX_ARG_OPTIONAL),
    PMIX_OPTION_DEFINE(PRTE_CLI_STOP_IN_INIT, PMIX_ARG_OPTIONAL),
