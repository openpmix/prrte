...
PRTE_MCA_BASE_FRAMEWORK_DECLARE(prte, rml, "PRTE Run-Time Messaging Layer",
                                 prte_rml_base_register, prte_rml_base_open, prte_rml_base_close,
                                 prte_rml_base_static_components, PRTE_MCA_BASE_FRAMEWORK_FLAG_DEFAULT);
...
int prte_rml_base_select(void)
{
     ...
     */
    if( PRTE_SUCCESS != prte_mca_base_select("rml", prte_rml_base_framework.framework_output,
...
PRTE_CLASS_INSTANCE(prte_rml_send_request_t,
                   prte_object_t,
...
PRTE_CLASS_INSTANCE(prte_rml_posted_recv_t,
                   prte_list_item_t,
                   prcv_cons, NULL);
...
PRTE_CLASS_INSTANCE(prte_rml_recv_request_t,
                   prte_object_t,
                   prq_cons, prq_des);
