 ...
 * information.  These functions are generally used during prrte_init
 * and prrte_finalize.
 */
 ...
 * prrte_rml.get_contact_info().  Generally used to extract the peer
 ...
 *
 * @retval PRRTE_SUCCESS     Information successfully extraced
 * @retval PRRTE_ERR_BAD_PARAM The contact_info was not a valid string
 * @retval PRRTE_ERROR       An unspecified error occurred
 */
PRRTE_EXPORT int prrte_rml_base_parse_uris(const char* contact_inf,
