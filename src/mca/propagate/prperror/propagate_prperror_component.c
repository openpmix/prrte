 ...
 */
const char *prte_mca_propagate_prperror_component_version_string
 ...
 */
prte_propagate_base_component_t prte_mca_propagate_prperror_component = {
    ...
    .base_version = {
        ...
        .pmix_mca_open_component = propagate_prperror_open,
        .pmix_mca_close_component = propagate_prperror_close,
        .pmix_mca_query_component = propagate_prperror_component_query,
        .pmix_mca_register_component_params = propagate_prperror_register,
    },
};
...
static int propagate_prperror_register(void)
{
    pmix_mca_base_component_t *c = &prte_mca_propagate_prperror_component.base_version;
