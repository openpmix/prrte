...
int prte_propagate_base_select(void)
{
     ...
     */
    if (PRTE_SUCCESS
        != pmix_mca_base_select("propagate", prte_propagate_base_framework.framework_output,
    ...
    PRTE_OUTPUT_VERBOSE((5, prte_propagate_base_framework.framework_output, "propagate selected"));
