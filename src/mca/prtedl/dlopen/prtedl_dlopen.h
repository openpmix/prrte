...
PRRTE_EXPORT extern prrte_prtedl_base_module_t prrte_prtedl_dlopen_module;
...
} prrte_prtedl_dlopen_component_t;

PRRTE_EXPORT extern prrte_prtedl_dlopen_component_t prrte_prtedl_dlopen_component;
