 ...
 * @file
 */
#ifndef PRRTE_RTC_HWLOC_H
#define PRRTE_RTC_HWLOC_H
...
} prrte_rtc_hwloc_vm_hole_kind_t;
...
} prrte_rtc_hwloc_vm_map_kind_t;

typedef struct {
    prrte_rtc_base_component_t super;
