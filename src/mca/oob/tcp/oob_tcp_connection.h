...
PRRTE_CLASS_DECLARATION(mca_oob_tcp_conn_op_t);
...
#define PRRTE_ACTIVATE_TCP_CONN_STATE(p, cbfunc)                         \
    do {                                                                \
        ...
        cop = PRRTE_NEW(mca_oob_tcp_conn_op_t);                           \
        cop->peer = (p);                                                \
...
PRRTE_MODULE_EXPORT void mca_oob_tcp_peer_try_connect(int fd, short args, void *cbdata);
PRRTE_MODULE_EXPORT void mca_oob_tcp_peer_dump(mca_oob_tcp_peer_t* peer, const char* msg);
PRRTE_MODULE_EXPORT bool mca_oob_tcp_peer_accept(mca_oob_tcp_peer_t* peer);
PRRTE_MODULE_EXPORT void mca_oob_tcp_peer_complete_connect(mca_oob_tcp_peer_t* peer);
PRRTE_MODULE_EXPORT int mca_oob_tcp_peer_recv_connect_ack(mca_oob_tcp_peer_t* peer,
                                                           int sd, mca_oob_tcp_hdr_t *dhdr);
PRRTE_MODULE_EXPORT void mca_oob_tcp_peer_close(mca_oob_tcp_peer_t *peer);
