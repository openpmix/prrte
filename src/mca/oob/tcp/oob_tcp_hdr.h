...
#define MCA_OOB_TCP_HDR_NTOH(h)                \
    PRRTE_PROCESS_NAME_NTOH((h)->origin);        \
    PRRTE_PROCESS_NAME_NTOH((h)->dst);           \
    (h)->tag = PRRTE_RML_TAG_NTOH((h)->tag);     \
...
#define MCA_OOB_TCP_HDR_HTON(h)                \
    PRRTE_PROCESS_NAME_HTON((h)->origin);        \
    PRRTE_PROCESS_NAME_HTON((h)->dst);           \
    (h)->tag = PRRTE_RML_TAG_HTON((h)->tag);     \
