...
PRTE_MODULE_EXPORT extern mca_oob_tcp_component_t mca_oob_tcp_component;

PRTE_MODULE_EXPORT void mca_oob_tcp_component_set_module(int fd, short args, void *cbdata);
PRTE_MODULE_EXPORT void mca_oob_tcp_component_lost_connection(int fd, short args, void *cbdata);
PRTE_MODULE_EXPORT void mca_oob_tcp_component_failed_to_connect(int fd, short args, void *cbdata);
PRTE_MODULE_EXPORT void mca_oob_tcp_component_no_route(int fd, short args, void *cbdata);
PRTE_MODULE_EXPORT void mca_oob_tcp_component_hop_unknown(int fd, short args, void *cbdata);
