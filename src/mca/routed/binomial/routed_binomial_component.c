...
static int prrte_routed_binomial_component_query(prrte_mca_base_module_t **module, int *priority);

/**
 * component definition
 */
prrte_routed_component_t prrte_routed_binomial_component = {
    ...
    .base_version = {
        ...
        .mca_query_component = prrte_routed_binomial_component_query
    },
    .base_data = {
...
static int prrte_routed_binomial_component_query(prrte_mca_base_module_t **module, int *priority)
{
     ...
     */
    *priority = 30;
    *module = (prrte_mca_base_module_t *) &prrte_routed_binomial_module;
