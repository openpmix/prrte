...
static int prte_mca_routed_direct_component_query(pmix_mca_base_module_t **module, int *priority);

/**
 * component definition
 */
prte_routed_component_t prte_mca_routed_direct_component = {
    ...
    .pmix_mca_query_component = prte_mca_routed_direct_component_query
};
