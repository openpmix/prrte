 ...
 */
prte_ess_base_component_t mca_ess_slurm_component = {
    ...
    .pmix_mca_open_component = mca_ess_slurm_component_open,
    .pmix_mca_close_component = mca_ess_slurm_component_close,
    .pmix_mca_query_component = mca_ess_slurm_component_query,
};
