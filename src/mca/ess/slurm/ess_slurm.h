...
#ifndef PRRTE_ESS_SLURM_H
#define PRRTE_ESS_SLURM_H
 ...
 * Module open / close
 */
int prrte_ess_slurm_component_open(void);
int prrte_ess_slurm_component_close(void);
int prrte_ess_slurm_component_query(prrte_mca_base_module_t **module, int *priority);

END_C_DECLS

#endif /* PRRTE_ESS_SLURM_H */
