 ...
 */
prrte_compress_zlib_component_t prrte_compress_zlib_component = {
...
static int compress_zlib_register (void)
{
    ...
    prrte_compress_zlib_component.super.priority = 50;
    ret = prrte_mca_base_component_var_register (&prrte_compress_zlib_component.super.base_version,
                                           ...
                                           &prrte_compress_zlib_component.super.priority);
    if (0 > ret) {
        return ret;
    }

    prrte_compress_zlib_component.super.verbose = 0;
    ret = prrte_mca_base_component_var_register (&prrte_compress_zlib_component.super.base_version,
                                           "verbose",
                                           ...
                                           &prrte_compress_zlib_component.super.verbose);
...
static int compress_zlib_open(void)
{
     ...
     */
    if ( 0 != prrte_compress_zlib_component.super.verbose) {
        prrte_compress_zlib_component.super.output_handle = prrte_output_open(NULL);
        prrte_output_set_verbosity(prrte_compress_zlib_component.super.output_handle,
                                  prrte_compress_zlib_component.super.verbose);
    } else {
        prrte_compress_zlib_component.super.output_handle = prrte_compress_base_framework.framework_output;
    }

    /*
     * Debug output
     */
    prrte_output_verbose(10, prrte_compress_zlib_component.super.output_handle,
                        "compress:zlib: open()");
    prrte_output_verbose(20, prrte_compress_zlib_component.super.output_handle,
...
int prrte_compress_zlib_component_query(prrte_mca_base_module_t **module, int *priority)
{
    ...
    *priority = prrte_compress_zlib_component.super.priority;
