...
AC_DEFUN([MCA_prrte_prteif_linux_ipv6_COMPILE_MODE], [
...
# ------------------------------------------------
AC_DEFUN([MCA_prrte_prteif_linux_ipv6_CONFIG], [
    ...
    # happy.
    AS_IF([test "$prrte_found_sockaddr" = "yes" && test "$prrte_found_linux" = "yes"],
          [AC_MSG_RESULT([yes])
           $1],
          [AC_MSG_RESULT([no])
           $2])
