 ...
 */
const char *mca_errmgr_dvm_component_version_string
 ...
 */
prte_errmgr_base_component_t mca_errmgr_dvm_component = {
...
static int dvm_register(void)
{
    pmix_mca_base_component_t *c = &mca_errmgr_dvm_component.base_version;
