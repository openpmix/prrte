 ...
 */
const char *mca_errmgr_prted_component_version_string
 ...
 */
prte_errmgr_base_component_t mca_errmgr_prted_component =
{
...
static int errmgr_prted_register(void)
{
    pmix_mca_base_component_t *c = &mca_errmgr_prted_component.base_version;
