...
static int prte_rmaps_round_robin_query(prte_mca_base_module_t **module, int *priority);
...
prte_rmaps_base_component_t prte_rmaps_round_robin_component = {
    .base_version = {
        ...
        .mca_open_component = prte_rmaps_round_robin_open,
        .mca_close_component = prte_rmaps_round_robin_close,
        .mca_query_component = prte_rmaps_round_robin_query,
        .mca_register_component_params = prte_rmaps_round_robin_register,
    },
    .base_data = {
...
{
    my_priority = 10;
    (void) prte_mca_base_component_var_register(&prte_rmaps_round_robin_component.base_version,
...
static int prte_rmaps_round_robin_query(prte_mca_base_module_t **module, int *priority)
{
    ...
    *module = (prte_mca_base_module_t *) &prte_rmaps_round_robin_module;
    return PRTE_SUCCESS;
}
