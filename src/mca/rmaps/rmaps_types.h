 ...
 */
#define PRTE_RMAPS_BASE_VERSION_2_0_0 \
    PRTE_MCA_BASE_VERSION_2_1_0("rmaps", 2, 0, 0)
...
#define PRTE_SET_MAPPING_DIRECTIVE(target, pol) \
    (target) |= (pol)
#define PRTE_UNSET_MAPPING_DIRECTIVE(target, pol) \
    (target) &= ~(pol)
#define PRTE_GET_MAPPING_DIRECTIVE(pol) \
    ((pol) & 0xff00)
 ...
 * from the directives
 */
#define PRTE_GET_MAPPING_POLICY(pol) \
    ((pol) & 0x00ff)
/* macro to determine if mapping policy is set */
#define PRTE_MAPPING_POLICY_IS_SET(pol) \
    ((pol) & 0x00ff)
#define PRTE_SET_MAPPING_POLICY(target, pol)     \
...
#define PRTE_SET_RANKING_DIRECTIVE(target, pol) \
    (target) |= (pol)
#define PRTE_UNSET_RANKING_DIRECTIVE(target, pol) \
    (target) &= ~(pol)
#define PRTE_GET_RANKING_DIRECTIVE(pol) \
    ((pol) & 0xf000)
...
#define PRTE_GET_RANKING_POLICY(pol) \
    ((pol) & 0x0fff)
/* macro to determine if ranking policy is set */
#define PRTE_RANKING_POLICY_IS_SET(pol) \
    ((pol) & 0x0fff)
#define PRTE_SET_RANKING_POLICY(target, pol)     \
