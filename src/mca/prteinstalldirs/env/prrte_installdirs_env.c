...
prrte_prteinstalldirs_base_component_t prrte_prteinstalldirs_env_component = {
...
#define SET_FIELD(field, envname)                                         \
    do {                                                                  \
        char *tmp = getenv(envname);                                      \
         ...
         prrte_prteinstalldirs_env_component.install_dirs_data.field = tmp;   \
    } while (0)


static int
prteinstalldirs_env_open(void)
{
