...
AC_DEFUN([MCA_prrte_prteinstalldirs_config_PRIORITY], [0])

AC_DEFUN([MCA_prrte_prteinstalldirs_config_COMPILE_MODE], [
...
# ------------------------------------------------
AC_DEFUN([MCA_prrte_prteinstalldirs_config_CONFIG],[
