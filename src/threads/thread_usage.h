...
__prte_attribute_always_inline__ static inline type prte_thread_ ## name ## _fetch_ ## suffix (prte_atomic_ ## type *addr, type delta) \
{                                                                       \
    return prte_atomic_ ## name ## _fetch_ ## suffix (addr, delta);     \
}                                                                       \
                                                                        \
__prte_attribute_always_inline__ static inline type prte_thread_fetch_ ## name ## _ ## suffix (prte_atomic_ ## type *addr, type delta) \
{                                                                       \
...
__prte_attribute_always_inline__ static inline bool prte_thread_compare_exchange_strong_ ## suffix (prte_atomic_ ## addr_type *addr, type *compare, type value) \
{                                                                       \
    return prte_atomic_compare_exchange_strong_ ## suffix (addr, (addr_type *) compare, (addr_type) value); \
}

#define PRTE_THREAD_DEFINE_ATOMIC_SWAP(type, addr_type, suffix)         \
__prte_attribute_always_inline__ static inline type prte_thread_swap_ ## suffix (prte_atomic_ ## addr_type *ptr, type newvalue) \
{                                                                       \
...
#define PRTE_THREAD_COMPARE_EXCHANGE_STRONG_PTR(x, y, z) prte_thread_compare_exchange_strong_ptr ((prte_atomic_intptr_t *) x, (intptr_t *) y, (intptr_t) z)
...
#define PRTE_THREAD_SWAP_PTR(x, y) prte_thread_swap_ptr ((prte_atomic_intptr_t *) x, (intptr_t) y)
