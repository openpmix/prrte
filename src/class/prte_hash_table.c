...
PRTE_CLASS_INSTANCE(prte_hash_table_t, prte_object_t, prte_hash_table_construct,
...
static size_t prte_hash_round_capacity_up(size_t capacity)
{
...
prte_hash_table_init2(prte_hash_table_t *ht, size_t estimated_max_size, int density_numer,
...
static uint64_t prte_hash_hash_elt_uint32(prte_hash_element_t *elt)
{
    return elt->key.u32;
}

static const struct prte_hash_type_methods_t prte_hash_type_methods_uint32
    = {NULL, prte_hash_hash_elt_uint32};
...
prte_hash_table_get_value_uint32(prte_hash_table_t *ht, uint32_t key, void **value)
{
    ...
    if (NULL != ht->ht_type_methods && &prte_hash_type_methods_uint32 != ht->ht_type_methods) {
        prte_output(0, "prte_hash_table_get_value_uint32:"
...
int prte_hash_table_remove_value_uint32(prte_hash_table_t *ht, uint32_t key)
{
    size_t ii, capacity = ht->ht_capacity;
...
static uint64_t prte_hash_hash_elt_uint64(prte_hash_element_t *elt)
{
    return elt->key.u64;
}

static const struct prte_hash_type_methods_t prte_hash_type_methods_uint64
    = {NULL, prte_hash_hash_elt_uint64};
...
prte_hash_table_get_value_uint64(prte_hash_table_t *ht, uint64_t key, void **value)
{
    ...
    if (NULL != ht->ht_type_methods && &prte_hash_type_methods_uint64 != ht->ht_type_methods) {
        prte_output(0, "prte_hash_table_get_value_uint64:"
                       "hash table is for a different key type");
        return PRTE_ERROR;
    }
...
static uint64_t prte_hash_hash_key_ptr(const void *key, size_t key_size)
{
    uint64_t hash;
...
static void prte_hash_destruct_elt_ptr(prte_hash_element_t *elt)
{
...
static uint64_t prte_hash_hash_elt_ptr(prte_hash_element_t *elt)
{
    return prte_hash_hash_key_ptr(elt->key.ptr.key, elt->key.ptr.key_size);
}

static const struct prte_hash_type_methods_t prte_hash_type_methods_ptr
    = {prte_hash_destruct_elt_ptr, prte_hash_hash_elt_ptr};

int /* PRTE_ return code */
prte_hash_table_get_value_ptr(prte_hash_table_t *ht, const void *key, size_t key_size, void **value)
{
    size_t ii, capacity = ht->ht_capacity;
    prte_hash_element_t *elt;
    ...
    if (NULL != ht->ht_type_methods && &prte_hash_type_methods_ptr != ht->ht_type_methods) {
        prte_output(0, "prte_hash_table_get_value_ptr:"
                       "hash table is for a different key type");
        return PRTE_ERROR;
    }
...
int /* PRTE_ return code */
prte_hash_table_set_value_ptr(prte_hash_table_t *ht, const void *key, size_t key_size, void *value)
{
    int rc;
    size_t ii, capacity = ht->ht_capacity;
    prte_hash_element_t *elt;
...
int /* PRTE_ return code */
prte_hash_table_remove_value_ptr(prte_hash_table_t *ht, const void *key, size_t key_size)
{
    size_t ii, capacity = ht->ht_capacity;
...
int /* PRTE_ return code */
prte_hash_table_get_first_key_uint32(prte_hash_table_t *ht, uint32_t *key, void **value,
                                     void **node)
{
...
int /* PRTE_ return code */
prte_hash_table_get_next_key_uint32(prte_hash_table_t *ht, uint32_t *key, void **value,
...
int /* PRTE_ return code */
prte_hash_table_get_first_key_ptr(prte_hash_table_t *ht, void **key, size_t *key_size, void **value,
                                  void **node)
{
...
int /* PRTE_ return code */
prte_hash_table_get_next_key_ptr(prte_hash_table_t *ht, void **key, size_t *key_size, void **value,
                                 void *in_node, void **out_node)
{
    prte_hash_element_t *elt;
    if (PRTE_SUCCESS == prte_hash_table_get_next_elt(ht, (prte_hash_element_t *) in_node, &elt)) {
...
int /* PRTE_ return code */
prte_hash_table_get_first_key_uint64(prte_hash_table_t *ht, uint64_t *key, void **value,
                                     void **node)
{
...
int /* PRTE_ return code */
prte_hash_table_get_next_key_uint64(prte_hash_table_t *ht, uint64_t *key, void **value,
                                    void *in_node, void **out_node)
{
    prte_hash_element_t *elt;
    if (PRTE_SUCCESS == prte_hash_table_get_next_elt(ht, (prte_hash_element_t *) in_node, &elt)) {
