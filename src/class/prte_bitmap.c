...
PRTE_CLASS_INSTANCE(prte_bitmap_t, prte_object_t, prte_bitmap_construct, prte_bitmap_destruct);
...
int prte_bitmap_init(prte_bitmap_t *bm, int size)
{
    /*
...
int prte_bitmap_set_bit(prte_bitmap_t *bm, int bit)
{
...
int prte_bitmap_clear_bit(prte_bitmap_t *bm, int bit)
{
    int index, offset;
...
bool prte_bitmap_is_set_bit(prte_bitmap_t *bm, int bit)
{
    int index, offset;
...
int prte_bitmap_clear_all_bits(prte_bitmap_t *bm)
{
    if (NULL == bm) {
        return PRTE_ERR_BAD_PARAM;
    }
...
int prte_bitmap_set_all_bits(prte_bitmap_t *bm)
{
    if (NULL == bm) {
        return PRTE_ERR_BAD_PARAM;
    }
...
int prte_bitmap_find_and_set_first_unset_bit(prte_bitmap_t *bm, int *position)
{
    int i = 0;
