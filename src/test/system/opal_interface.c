...
int main(int argc, char* argv[])
{
    ...
    if (PRRTE_SUCCESS != mca_base_framework_open(&opal_if_base_framework, 0)) {
    ...
    if (2 == argc) {
        ...
        fprintf(stderr, "netaddr %03d.%03d.%03d.%03d netmask %03d.%03d.%03d.%03d rc %d\n",
                PRRTE_IF_FORMAT_ADDR(netaddr), PRRTE_IF_FORMAT_ADDR(netmask), rc);
        ...
        while (0 < idx) {
            ...
            fprintf(stderr, "checking netaddr %03d.%03d.%03d.%03d addr %03d.%03d.%03d.%03d netmask %03d.%03d.%03d.%03d rc %d\n",
                    PRRTE_IF_FORMAT_ADDR(netaddr), PRRTE_IF_FORMAT_ADDR(addr), PRRTE_IF_FORMAT_ADDR(netmask), rc);
