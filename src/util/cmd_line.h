...
BEGIN_C_DECLS
    ...
    struct prrte_cmd_line_t {
        ...
        prrte_list_t lcl_options;

        /** Duplicate of argc from prrte_cmd_line_parse() */
        int lcl_argc;
        /** Duplicate of argv from prrte_cmd_line_parse() */
        char **lcl_argv;

        /** Parsed output; list of prrte_cmd_line_param_t's (defined internally) */
     ...
     * Convenience typedef
     */
    typedef struct prrte_cmd_line_t prrte_cmd_line_t;

    /**
     * Data types supported by the parser
     */
    enum prrte_cmd_line_type_t {
     ...
     * Convenience typedef
     */
    typedef enum prrte_cmd_line_type_t prrte_cmd_line_type_t;

    /**
     * Command line option type, for use in
     * mpirun --help output.
     */
    enum prrte_cmd_line_otype_t {
     ...
     * Convenience typedef
     */
    typedef enum prrte_cmd_line_otype_t prrte_cmd_line_otype_t;

    /**
     * Datatype used to construct a command line handle; see
     * prrte_cmd_line_create().
     */
    struct prrte_cmd_line_init_t {
     ...
     * Convenience typedef
     */
    typedef struct prrte_cmd_line_init_t prrte_cmd_line_init_t;
     ...
     * from others.
     *
     * The prrte_cmd_line_t handles are [simplisticly] thread safe;
     ...
     *      &orterun_globals.help, PRRTE_CMD_LINE_TYPE_BOOL,
     *      "This help message" },
     *
     *    { NULL, NULL, NULL, '\0', NULL, "wd", 1,
     *      &orterun_globals.wd, PRRTE_CMD_LINE_TYPE_STRING,
     ...
     */
    PRRTE_EXPORT char *prrte_cmd_line_get_usage_msg(prrte_cmd_line_t *cmd) __prrte_attribute_malloc__ __prrte_attribute_warn_unused_result__;
     ...
     *
     * @retval PRRTE_ERROR If cmd is NULL.
     * @retval argc Number of arguments previously added to the handle.
     *
     * Arguments are added to the handle via the prrte_cmd_line_parse()
     * function.
     */
    PRRTE_EXPORT int prrte_cmd_line_get_argc(prrte_cmd_line_t *cmd) __prrte_attribute_unused__;
     ...
     * caller.
     */
    PRRTE_EXPORT char *prrte_cmd_line_get_param(prrte_cmd_line_t *cmd,
                                                const char *opt,
                                                int instance_num,
                                                int param_num);
