 ...
 * permissions. The function will return PRTE_ERROR if this cannot
 * be done.
 **/

#ifndef PRTE_OS_DIRPATH_CREATE_H
#define PRTE_OS_DIRPATH_CREATE_H
 ...
 * @retval PRTE_SUCCESS If the directory tree has been successfully created with
 * the specified access permissions.
 * @retval PRTE_ERROR If the directory tree could not be created with the
 ...
 *
 * @retval PRTE_SUCCESS If directory exists, and permissions match
 ...
 *
 * @retval PRTE_SUCCESS If the directory was successfully removed or removed to the
 ...
 */
PRTE_EXPORT int prte_os_dirpath_destroy(const char *path,
                                          bool recursive,
