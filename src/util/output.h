 ...
 * writing to it.
 */
PRTE_EXPORT void prte_output(int output_id, const char *format, ...)
 ...
 */
PRTE_EXPORT void prte_output_vverbose(int verbose_level, int output_id, const char *format,
                                      va_list ap) __prte_attribute_format__(__printf__, 3, 0);
 ...
 */
PRTE_EXPORT char *prte_output_string(int verbose_level, int output_id, const char *format, ...)
    __prte_attribute_format__(__printf__, 3, 4);

/**
 * Same as prte_output_string, but accepts a va_list form of varargs.
 */
PRTE_EXPORT char *prte_output_vstring(int verbose_level, int output_id, const char *format,
                                      va_list ap) __prte_attribute_format__(__printf__, 3, 0);
 ...
 */
PRTE_EXPORT void prte_output_set_output_file_info(const char *dir, const char *prefix,
