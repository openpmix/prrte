...
#define PRTE_TIMEOUT_DEFAULT    {1, 0}
...
PRTE_EXPORT int prte_event_assign(struct event *ev, prte_event_base_t *evbase,
                                  int fd, short arg, event_callback_fn cbfn, void *cbd);

#define prte_event_set(b, x, fd, fg, cb, arg) prte_event_assign((x), (b), (fd), (fg), (event_callback_fn) (cb), (arg))
...
PRTE_EXPORT prte_event_t* prte_event_new(prte_event_base_t *b, int fd,
...
#define prte_event_evtimer_set(b, x, cb, arg) prte_event_assign((x), (b), -1, 0, (event_callback_fn) (cb), (arg))
...
#define prte_event_signal_set(b, x, fd, cb, arg) prte_event_assign((x), (b), (fd), EV_SIGNAL|EV_PERSIST, (event_callback_fn) (cb), (arg))
