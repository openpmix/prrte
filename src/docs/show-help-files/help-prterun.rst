...
.. list-table::
   ...
   * - ``--add-host <hosts>``
     - List of hosts to add to the DVM prior to launching the given
       app
   ...
   * - ``--add-hostfile <file>``
     - Provide a hostfile listing hosts to add to the DVM prior to
...
.. include:: /prrte-rst-content/cli-add-hostfile.rst
...
.. include:: /prrte-rst-content/cli-add-host.rst
